...
import 'package:flutter_intern_workshop/chart/sample1.dart';
import 'package:flutter_intern_workshop/chart/sample2.dart';
import 'package:flutter_intern_workshop/chart/sample3.dart';
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => QRCodeAndBarcode()),
                  );
                },
                child: Container(
                  height: 100,
